...
def reg():
    ...
    time.sleep(1) 
    try:
        to = open('/sdcard/Android/.RtHAROON JANI6.txt', 'r').read()
    except (KeyError, IOError):
        reg2()
    r = requests.get('https://github.com/haroonhacker213389/haroon/blob/main/Haroon.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('xdg-open https://whatsapp.me/+93776811468?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    sav = open('/sdcard/Android/.RtHaroon JaNi.txt', 'w')
    sav.write(id)
    sav.close()
    reg()
...
def hasil(OK,cp):
    if len(OK) != 0 or len(cp) != 0:
        ...
        print('----------------------------------------------')
        print(' [%s+%s] \033[1;97mTOTAL OK : %s --- \033[1;97mHarron JaNi-ok.txt'%(O,O,str(len(ok))))
        print(' [%s+%s] \033[1;97mTOTAL CP : %s --- \033[1;97mHaroon JaNi-cp.txt'%(O,O,str(len(cp))))
        print('----------------------------------------------')
...
def bsn_menu():
    ...
    print(" [*]. Facebook   . (Haroon JaNi)");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(" [*]. VERSION  3.0                                    ");time.sleep (0.03)   
    print(" [*]. WP             +93776811468      ");time.sleep (0.03)
    print(" [*]. This Tool was created by HAROON JANI              ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
